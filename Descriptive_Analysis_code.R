data=read.csv("C:/Users/Admin/Desktop/university work/Level 3 sem 2/ST3082 - Statistical Learning - I/Project 03/Report/Used_Bikes.csv")
View(data)
head(data)
names(data)
summary(data)
...
df= read.csv("C:/Users/Admin/Desktop/university work/Level 3 sem 2/ST3082 - Statistical Learning - I/Project 03/Report/cities.csv")
sum(duplicated(df))
df=distinct(df)
table(df$State)
nrow(df)
...
data=subset(data,select = -c(brand_New))
trainset=subset(trainset,select = -c(brand_New))
